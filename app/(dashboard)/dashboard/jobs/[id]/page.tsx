...
export default function JobDetailPage() {
 ...
 @media (max-width: 480px) {
  ...
  /* Bottom row: status + actions full width */
  .c-right {
    width: 100%;
                          ...
                          >
                            ...
                            <button
                              onClick={() => {
                                ...
                                doc.setFont("helvetica", "bold");
                                doc.setTextColor(255, 255, 255);
                                doc.text("Interview Questions", margin, 16);

                                doc.setFontSize(9);
                                doc.setFont("helvetica", "normal");
                                doc.setTextColor(180, 210, 255);
                                doc.text(
                                  "Generated by SahiScreen AI",
                                  margin,
                                  25,
                                );
                                doc.text(
                                ...
                                doc.setTextColor(100, 116, 139);
                                doc.text(
                                  `Job: ${job?.title ?? "N/A"}   |   ${candidate.candidate_email}`,
                                  margin,
                                  y,
                                );
                                ...
                                for (let p = 1; p <= totalPages; p++) {
                                  ...
                                  doc.setTextColor(148, 163, 184);
                                  doc.text(
                                    "Generated by SahiScreen · sahiscreen.com",
                                    margin,
                                    290,
                                  );
                                  doc.text(
                                ...
                                doc.save(
                                  `interview-questions-${candidate.candidate_name.replace(/\s+/g, "-").toLowerCase()}-${new Date().toISOString().slice(0, 10)}.pdf`,
                                );
                              }}
                              style={{
                                display: "inline-flex",
